...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a href="http://goo.gl/s60l8M">2.48.1</a>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>2.48.1</td>
        <td>2015-10-08</td>
        <td><a href="http://selenium-release.storage.googleapis.com/2.48/selenium-java-2.48.1.zip">Download</a>&nbsp;&nbsp;</td>

...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  "http://xserve.openqa.org:8085/">latest releases</a>, <a href="http://seleniumhq.org/download/source.html">source
  ...
  <p>Download version <a href="http://release.seleniumhq.org/selenium-ide/1.9.0/selenium-ide-1.9.0.xpi">1.9.0</a> released on 24/July/2012 or view the <a href="http://code.google.com/p/selenium/wiki/SeIDEReleaseNotes">Release Notes</a></p>
  ...
  <p>Download version <a
    href="http://selenium.googlecode.com/files/selenium-server-standalone-2.25.0.jar">2.25.0</a>
  </p>
  ...
  <p>Download version 2.25.2 for (recommended) <a
    href="http://code.google.com/p/selenium/downloads/detail?name=IEDriverServer_Win32_2.25.2.zip">32
    bit Windows IE</a> or <a
    href="http://code.google.com/p/selenium/downloads/detail?name=IEDriverServer_x64_2.25.2.zip">64 bit Windows IE</a></p>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>2.25.0</td>
        <td>2012-07-18</td>
        <td><a href="http://selenium.googlecode.com/files/selenium-java-2.25.0.zip">Download</a>&nbsp;&nbsp;</td>
      ...
      <tr>
        ...
        <td>2.25.1</td>
        <td>2012-07-19</td>
        <td><a href="http://selenium.googlecode.com/files/selenium-dotnet-2.25.1.zip">Download</a></td>
  ...
  <h4>C# NuGet</h4>
  <p>NuGet lastest release is 2.25.1, Released on 2012-07-19</p>
  <ul>

...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version 2.53.0 for (recommended) <a
    href="http://selenium-release.storage.googleapis.com/2.53/IEDriverServer_Win32_2.53.0.zip">32
    bit Windows IE</a> or <a
    href="http://selenium-release.storage.googleapis.com/2.53/IEDriverServer_x64_2.53.0.zip">64 bit Windows IE</a><br/>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td><a href="https://developer.microsoft.com/en-us/microsoft-edge/platform/status/webdriver">Microsoft Edge Driver</a></td>
        <td colspan=2>
          <a href="https://www.microsoft.com/en-us/download/details.aspx?id=49962">2.0&nbsp;(10586)</a><br/>
          <a href="https://www.microsoft.com/en-us/download/details.aspx?id=48740">2.1&nbsp;(insiders)</a>
        </td>

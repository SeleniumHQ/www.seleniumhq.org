...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a
    href="http://selenium-release.storage.googleapis.com/2.42/selenium-server-standalone-2.42.0.jar">2.42.0</a>
  </p>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>2.42.0</td>
        <td>2014-05-22</td>
        <td><a href="http://selenium-release.storage.googleapis.com/2.42/selenium-java-2.42.0.zip">Download</a>&nbsp;&nbsp;</td>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td><a href="http://chromedriver.storage.googleapis.com/index.html?path=2.9/">2.9</a>&nbsp;&nbsp;</td>
        <td><a href="http://chromedriver.storage.googleapis.com/2.9/notes.txt">change log</a>&nbsp;&nbsp;</td>

...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a
    href="http://selenium.googlecode.com/files/selenium-server-standalone-2.37.0.jar">2.37.0</a>
  </p>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>2.37.0</td>
        <td>2013-10-18</td>
        <td><a href="http://selenium.googlecode.com/files/selenium-java-2.37.0.zip">Download</a>&nbsp;&nbsp;</td>
      ...
      <tr>
        ...
        <td>2.37.0</td>
        <td>2013-10-18</td>
        <td><a href="http://selenium.googlecode.com/files/selenium-dotnet-2.37.0.zip">Download</a></td>
  ...
  <h4>C# NuGet</h4>
  <p>NuGet latest release is 2.37.0, Released on 2013-10-18</p>
  <ul>

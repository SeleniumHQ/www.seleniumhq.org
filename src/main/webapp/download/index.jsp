  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>3.3.1</td>
        <td>2017-03-10</td>
        <td><a href="http://selenium-release.storage.googleapis.com/3.3/selenium-java-3.3.1.zip">Download</a>&nbsp;&nbsp;</td>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="http://chromedriver.storage.googleapis.com/index.html?path=2.28/">2.28</a>&nbsp;&nbsp;</td>
        <td><a href="http://chromedriver.storage.googleapis.com/2.28/notes.txt">change log</a>&nbsp;&nbsp;</td>
      ...
      <tr>
        ...
        <td><a href="https://github.com/SeleniumHQ/htmlunit-driver/releases">2.25</a></td>
        <td>&nbsp;</td>
        <td><a href="https://github.com/seleniumhq/htmlunit-driver/issues">issue tracker</a></td>
	<td>&nbsp;&nbsp;</td>
	<td>Released 2017-02-23</td>
      </tr>
      <tr>

  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="http://chromedriver.storage.googleapis.com/index.html?path=2.27/">2.27</a>&nbsp;&nbsp;</td>
        <td><a href="http://chromedriver.storage.googleapis.com/2.27/notes.txt">change log</a>&nbsp;&nbsp;</td>
      ...
      <tr>
        ...
        <td><a href="https://github.com/SeleniumHQ/htmlunit-driver/releases">2.24</a></td>
        <td>&nbsp;</td>
        <td><a href="https://github.com/seleniumhq/htmlunit-driver/issues">issue tracker</a></td>
	<td>&nbsp;&nbsp;</td>
	<td>Released 2017-02-14</td>
      </tr>
      <tr>

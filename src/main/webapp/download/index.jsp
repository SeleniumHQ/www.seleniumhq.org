...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a href="http://goo.gl/EUxR76">3.0.0-beta3</a>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="http://chromedriver.storage.googleapis.com/index.html?path=2.23/">2.23</a>&nbsp;&nbsp;</td>
        <td><a href="http://chromedriver.storage.googleapis.com/2.23/notes.txt">change log</a>&nbsp;&nbsp;</td>

...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <h3>Selenium GRID Packaging</h3>
  <p><a href="https://launchpad.net/~siostechcorp/+archive/ubuntu/selenium-grid">Ubuntu PPA</a> for Hub, Node, Headless Node; Nodes bundled with Chromedriver and Geckodriver.</p>

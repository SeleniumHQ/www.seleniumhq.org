...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a href="http://goo.gl/XzdgHy">2.49.0</a>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>2.49.0</td>
        <td>2016-01-13</td>
        <td><a href="http://selenium-release.storage.googleapis.com/2.49/selenium-java-2.49.0.zip">Download</a>&nbsp;&nbsp;</td>

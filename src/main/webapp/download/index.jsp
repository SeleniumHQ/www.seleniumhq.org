...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download latest released version <a href="http://release.seleniumhq.org/selenium-ide/1.9.1/selenium-ide-1.9.1.xpi">1.9.1</a> released on 11/October/2012 or view the <a href="http://code.google.com/p/selenium/wiki/SeIDEReleaseNotes">Release Notes</a></p>

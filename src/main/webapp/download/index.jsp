...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version 2.32.0 for (recommended) <a
    href="http://code.google.com/p/selenium/downloads/detail?name=IEDriverServer_Win32_2.32.0.zip">32
    bit Windows IE</a> or <a
    href="http://code.google.com/p/selenium/downloads/detail?name=IEDriverServer_x64_2.32.0.zip">64 bit Windows IE</a></p>

...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a href="http://goo.gl/RXxPg6">2.48.0</a>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>2.48.0</td>
        <td>2015-10-07</td>
        <td><a href="http://selenium-release.storage.googleapis.com/2.48/selenium-java-2.48.0.zip">Download</a>&nbsp;&nbsp;</td>

...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Download version <a href="https://goo.gl/LSKE9I">3.0.0</a>
  ...
  <p>To run Selenium tests exported from IDE, use the <a href="https://goo.gl/t3SJdl">Selenium Html Runner</a>.</p>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>3.0.0</td>
        <td>2016-10-13</td>
        <td><a href="http://selenium-release.storage.googleapis.com/3.0/selenium-java-3.0.0.zip">Download</a>&nbsp;&nbsp;</td>

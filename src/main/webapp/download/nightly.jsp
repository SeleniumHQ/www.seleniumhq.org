...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  contained in our <a href="maven.html">Maven repository</a>. In
  the future, we may provide the nightly releases in another
  location, but for now please navigate the <b>snapshots</b> Maven
  repository to find our nightlies.</p>

  <p>Note: Even if you're not using Java, you can find non-Java

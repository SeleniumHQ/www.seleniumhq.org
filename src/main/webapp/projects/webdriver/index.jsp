...
<%@include file="/jsp/header.jspf"%><div id="mainContent">
  ...
  <p>Eventually there will be more content on this page, but for now please see <a href="http://seleniumhq.org/docs/03_webdriver.html">the documentation</a> and <a href="http://seleniumhq.org/docs/appendix_migrating_from_rc_to_webdriver.html">Remote Control to WebDriver Migration Notes</a>.</p>
</body>
